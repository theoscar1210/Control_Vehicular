...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    // --- Verificación de disponibilidad (requiere token válido) ---
    ...
    // --- Usuarios (solo ADMIN — SST no tiene 'usuarios:read' ni '*') ---
    // Nota: 'abilities' (CheckForAnyAbility) = OR lógico. Un token con ['*'] pasa por la primera condición.
    Route::middleware('abilities:*,usuarios:read')->group(function () {
    ...
    // --- Propietarios ---
    Route::middleware('abilities:*,propietarios:read')->group(function () {
    ...
    Route::middleware(['abilities:*,propietarios:write', 'throttle:api-write'])->group(function () {
    ...
    // --- Conductores ---
    Route::middleware('abilities:*,conductores:read')->group(function () {
    ...
    Route::middleware(['abilities:*,conductores:write', 'throttle:api-write'])->group(function () {
    ...
    // --- Vehículos ---
    Route::middleware('abilities:*,vehiculos:read')->group(function () {
    ...
    Route::middleware(['abilities:*,vehiculos:write', 'throttle:api-write'])->group(function () {
    ...
    Route::middleware('abilities:*,documentos:read')->group(function () {
    ...
    Route::middleware(['abilities:*,documentos:write', 'throttle:api-write'])->group(function () {
    ...
    // --- Alertas ---
    Route::middleware('abilities:*,alertas:read')->group(function () {
    ...
    Route::middleware(['abilities:*,alertas:write', 'throttle:api-write'])->group(function () {
