            ...
            <form method="POST" action="{{ route('vehiculos.documentos.update', [$vehiculo->id_vehiculo, $doc->id_doc_vehiculo]) }}">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="numero_tecno_{{ $doc->id_doc_vehiculo }}" class="form-label fw-semibold">
                                Número de Certificado <span class="text-danger">*</span>
                            </label>
                            <input type="text"
                                class="form-control @error('numero_documento') is-invalid @enderror"
                                id="numero_tecno_{{ $doc->id_doc_vehiculo }}"
                        ...
                        {{-- CDA --}}
                        <div class="col-md-6 mb-3">
                            <label for="cda_{{ $doc->id_doc_vehiculo }}" class="form-label fw-semibold">
                                Centro de Diagnóstico (CDA)
                            </label>
                            <input type="text"
                                class="form-control @error('entidad_emisora') is-invalid @enderror"
                                id="cda_{{ $doc->id_doc_vehiculo }}"
                                name="entidad_emisora"
                                value="{{ old('entidad_emisora', '') }}"
                                placeholder="Ej: CDA Suramericana">
                    ...
                    <div class="row">
                        {{-- FECHA REVISIÓN --}}
                        <div class="col-md-6 mb-3">
                            <label for="fecha_revision_{{ $doc->id_doc_vehiculo }}" class="form-label fw-semibold">
                                Fecha de Revisión <span class="text-danger">*</span>
                            </label>
                            <input type="date"
                                class="form-control @error('fecha_emision') is-invalid @enderror"
                                id="fecha_revision_{{ $doc->id_doc_vehiculo }}"
                                name="fecha_emision"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn text-white" style="background-color:#5B8238;"
                        ...
                        <i class="fa-solid fa-check-circle me-1"></i> Renovar Tecnomecánica
                    </button>
                </div>
