...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        th { background: #5B8238; color: white; }
        tr:nth-child(even) { background: #f8f9fa; }
        .estado-por_vencer { color: #856404; font-weight: bold; }
        .estado-vencido { color: #721c24; font-weight: bold; }
...
<body>
    ...
    <div class="header">
        <table class="header-table">
            <tr>
                ...
                <td>
                    <h1>REPORTE DE ALERTAS Y VENCIMIENTOS <span class="confidencial-badge">CONFIDENCIAL</span></h1>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="6" style="text-align: center;">Sin alertas de vehículos</td></tr>
            @endforelse
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
            <tr><td colspan="6" style="text-align: center;">Sin alertas de conductores</td></tr>
            @endforelse
        </tbody>
    </table>
